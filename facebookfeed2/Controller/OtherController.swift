...
class OtherController: UITableViewController, UIWebViewDelegate{
    ...
    override func viewDidLoad() {
        ...
        self.view.backgroundColor = UIColor.white //pagesBackColor
        tableView.separatorColor = pagesBackColor.withAlphaComponent(0.75)
        tableView.sectionHeaderHeight = 0 //26
